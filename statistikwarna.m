function [stat] = statistikwarna(ImgDir);

RGB = double(imread(ImgDir));
[m,n,d] = size(RGB);
...
%database
assignin('base','mean_red',stat.mean_r);
assignin('base','mean_green',stat.mean_g);
assignin('base','mean_blue',stat.mean_b);